...
//    [navBar setTintColor:[UIColor whiteColor]];
    ...
    [self.menuItems addObjectsFromArray:[NSArray arrayWithObjects:@"Màn hình chính",@"Thông tin", nil]];
}
...
//    }
    ...
    [cell.lbTitle setText:[self.menuItems objectAtIndex:indexPath.row]];
